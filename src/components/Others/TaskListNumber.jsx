...
const TaskListNumber = ({ data }) => {
  return (
    <div className="flex flex-wrap mt-10 justify-between gap-5 screen">
      <div className="w-full sm:w-[45%] md:w-[45%] py-6 px-9 bg-red-400 rounded-xl">
      ...
      <div className="w-full sm:w-[45%] md:w-[45%] py-6 px-9 bg-blue-400 rounded-xl">
      ...
      <div className="w-full sm:w-[45%] md:w-[45%] py-6 px-9 bg-green-400 rounded-xl">
        <h2 className="text-2xl sm:text-3xl font-semibold">{data.taskNumbers.active}</h2>
        <h3 className="text-lg sm:text-xl font-medium">Accept Task</h3>
      </div>
      <div className="w-full sm:w-[45%] md:w-[45%] py-6 px-9 bg-yellow-400 rounded-xl">
